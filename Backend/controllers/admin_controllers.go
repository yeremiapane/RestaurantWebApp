...
func (ac *AdminController) GetDashboardStats(c *gin.Context) {
	...
	utils.RespondJSON(c, http.StatusOK, "Dashboard statistics", stats)
}
...
func (ac *AdminController) MonitorOrderFlow(c *gin.Context) {
	...
	utils.RespondJSON(c, http.StatusOK, "Order flow status", orderFlow)
}
...
func (ac *AdminController) GetSalesReport(c *gin.Context) {
	...
	utils.RespondJSON(c, http.StatusOK, "Sales report", sales)
}
